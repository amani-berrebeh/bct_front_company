...
import { tripsmanagement } from 'Common/data/tripsmamagement';

const TripsManagement = () => {

    document.title = "Trips Management | School Administration";
        ...
        () => [
            {
                ...
                accessor: (cellProps: any) => {
                    return (<Link to="#" className="fw-medium link-primary">{cellProps.tripId}</Link>)
                },
            },
            {
                Header: "Schedule ID ",
            ...
            
            {
                ...
                accessor: "pickup_stations",
                disableFilters: true,
                filterable: true,
            },
            {
                Header: "DropDown Station",
                accessor: "dropdown_stations",
                disableFilters: true,
                filterable: true,
            },
            {
                Header: "Middle Stations",
                accessor: "middle_stations",
                disableFilters: true,
                filterable: true,
            },
            
            {
                ...
                accessor: (cellProps: any) => {
                    switch (cellProps.status) {
                        ...
                        case "OnRaod":
                            return (<span className="badge bg-secondary-subtle text-secondary"> {cellProps.status}</span>)
                        case "Paused":
                            return (<span className="badge bg-info-subtle text-info"> {cellProps.status}</span>)
                        default:
                            return (<span className="badge bg-success-subtle text-success"> {cellProps.status}</span>)
                    }
                },
                ...
                accessor: (cellProps: any) => {
                    return (
                        <ul className="hstack gap-2 list-unstyled mb-0">
                            <li>
                                <Link to="#" className="badge bg-info-subtle text-info view-item-btn"><i className="ph ph-eye"></i></Link>
                            </li>
                            <li>
        ...
        <React.Fragment>
            <div className="page-content">
                <Container fluid={true}>
                    <Breadcrumb title="Trip Management" pageTitle="" />
                    <Card id="shipmentsList">
                        {/* <Card.Header className="border-bottom-dashed">
                            <Row className="align-items-center g-3">
                                <Col xxl={3} sm={6}>
                                    <h6 className="card-title mb-0">Jobs Management</h6>
                                </Col>
                            ...
                            <Row className="g-3">
                                <Col xxl={3} lg={7}>
                                    <div className="search-box">
                                        <input type="text" className="form-control search" placeholder="Search for a Trip ..." />
                                ...
                                <Col xxl={2} lg={6}>
                                    <select className="form-select" data-choices data-choices-search-false name="choices-single-default" id="idStatus">
                                        ...
                                        <option value="Paused">Group 1</option>
                                        <option value="Pending">Group 2</option>
                                        <option value="OnRaod">Group 3</option>
                                        <option value="Cancelled">Group 4</option>
                                        <option value="Done">Group 5</option>
                                    </select>
                                </Col>
