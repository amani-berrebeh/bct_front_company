...
const EmployeePayment = () => {
    ...
    document.title = "Payment| Bouden Coach Travel";

    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid={true}>
                    <Breadcrumb title="Payments" pageTitle="Employees" />
                                ...
                                <Card.Body className="position-relative">
                                    <div className="d-flex align-items-center">
                                        <div className="flex-grow-1">
                                            <p className="text-uppercase fs-14 fw-medium text-muted mb-0">Total Cost</p>
                                        </div>
                                    ...
                                    <div className="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            ...
                                            <span className="badge bg-info me-1">6,258</span> <span className="text-muted align-bottom">The total cost of all finished trips</span>
                                        </div>
                        ...
                        <Col xl={3} md={6}>
                            ...
                            <Card className="card-animate bg-success-subtle border-0 overflow-hidden">
                                ...
                                <Card.Body className="position-relative">
                                    <div className="d-flex align-items-center">
                                        <div className="flex-grow-1">
                                            <p className="text-uppercase fs-14 fw-medium text-muted mb-0">Company Contribution</p>
                                        </div>
                                        <div className="flex-shrink-0">
                                            <h5 className="text-success fs-14 mb-0">
                                    ...
                                    <div className="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            ...
                                            <span className="badge bg-info me-1">2,451</span> <span className="text-muted">Company Contribution for all finished trips</span>
                                        </div>
                                        <div className="avatar-sm flex-shrink-0">
                        ...
                        <Col xl={3} md={6}>
                            ...
                            <Card className="card-animate bg-warning-subtle border-0 overflow-hidden">
                                ...
                                <Card.Body className="position-relative">
                                    <div className="d-flex align-items-center">
                                        <div className="flex-grow-1">
                                            <p className="text-uppercase fs-14 fw-medium text-muted mb-0">Employees Contribution</p>
                                        </div>
                                        <div className="flex-shrink-0">
                                    ...
                                    <div className="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            ...
                                            <span className="badge bg-info me-1">720</span> <span className="text-muted">Real Contribution for all finished trips</span>
                                        </div>
                                        <div className="avatar-sm flex-shrink-0">
