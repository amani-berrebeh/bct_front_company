            ...
            },
            {
                ...
                accessor: (cellProps: any) => {
                    switch (cellProps.paystatus) {
                        case "Paid":
                            return (<span className="badge bg-success-subtle text-success">{cellProps.paystatus}</span>)
                        case "Unpaid":
                            return (<span className="badge bg-warning-subtle text-warning">{cellProps.paystatus}</span>)
                        case "Refund":
                            return (<span className="badge bg-primary-subtle text-primary">{cellProps.paystatus}</span>)
                        default:
                            return (<span className="badge bg-danger-subtle text-danger">{cellProps.paystatus}</span>)
                    }
                },
            },
            {
