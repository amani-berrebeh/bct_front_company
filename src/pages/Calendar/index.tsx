...
const Calendar = () => {
    ...
    const searchCustomer = (ele: any) => {
        ...
        if (search) {
            ...
            setUpcommingEventList(events.filter((data: any) => (data.title.toLowerCase().includes(search))));
        } else {
            setUpcommingEventList(events);
        }
    };
            ...
            <div className="page-content">
                <Container fluid={true}>
                    ...
                    <Row>
                        ...
                        <Col xl={3}>
                            <Button variant="primary" className="w-100" id="btn-new-event" onClick={toggle}><i className="mdi mdi-plus"></i> Create New Schedule</Button>
                            <div className="mt-4">
                                <h5 className="mb-1 fs-18">Recent Added Schedules</h5>
                                ...
                                <SimpleBar className="pe-2 me-n1 mb-3" style={{ height: "595px" }}>
                                    <div id="upcoming-event-list">
                                        {UpcommingEventList &&
                                            (UpcommingEventList || []).map((event: any, key: number) => (
